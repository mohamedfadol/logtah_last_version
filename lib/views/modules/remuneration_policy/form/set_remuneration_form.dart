...
class SetRemunerationForm extends StatefulWidget {
  final Committee committee;
  const SetRemunerationForm({super.key, required this.committee});
  static const routeName = '/SetRemunerationForm';

  @override
  State<SetRemunerationForm> createState() => _SetRemunerationFormState();
}

class _SetRemunerationFormState extends State<SetRemunerationForm> {
