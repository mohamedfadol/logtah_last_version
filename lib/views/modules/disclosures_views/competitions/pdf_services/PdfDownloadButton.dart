            ...
            itemBuilder: (context, index) {
              ...
              return pw.Column(
                ...
                children: [
                  ...
                  pw.Text("Decision: ${member.pivot?.isAgree == 1 ? 'Approved' : 'Rejected'}", style: pw.TextStyle(fontSize: 10)),
                  if (member.pivot?.isAgree == true && member.memberSignature != null)
                ...
                itemBuilder: (context, index) {
                  ...
                  return pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text("القرار : ${member.pivot?.isAgree == 1 ? 'موافق' : 'غير موافق'}", style: pw.TextStyle(fontSize: 10)),
                      if (member.pivot?.isAgree == true && member.memberSignature != null)
                        pw.Image(pw.MemoryImage(base64Decode(member.memberSignature!)), height: 20, width: 70)
                      else
