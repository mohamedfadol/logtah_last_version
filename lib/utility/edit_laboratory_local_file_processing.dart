  ...
  Future<void> preparePdfFileFromNetwork() async {
    ...
    try {
      if(await PDFApi.requestPermission()){
        print('https https ------------------- https://diligov.com/public/meetings/'+widget.minute.minuteFile!);
